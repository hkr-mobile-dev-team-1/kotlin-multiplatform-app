...
fun AppNavHost() {
    ...
    val showBottomBar = currentDestination?.route !in listOf(Screen.Login.route, Screen.Register.route)
        ...
        NavHost(
            ...
            composable(Screen.Login.route) {
                LoginScreen(
                    ...
                    onLoginSuccess = { navController.navigate(Screen.Schedule.route) {
            ...
            composable(Screen.Register.route) {
                SignupScreen(
                    ...
                    onSignupSuccess = { navController.navigate(Screen.Schedule.route) {
